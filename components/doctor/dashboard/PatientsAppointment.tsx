      ...
      <div className="col-md-12">
        ...
        <div className="appointment-tab">
          ...
          <ul className="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
            <li
              onClick={() => dispacth(setDoctorDashTabTodayUpcoming(0))}
              className="nav-item"
            >
              <a
                className={`nav-link animate-in ease-linear ${
                  tab === 0 && "active"
                }`}
            ...
            <li
              onClick={() => dispacth(setDoctorDashTabTodayUpcoming(1))}
              className="nav-item"
            >
              <a
                className={`nav-link animate-in ease-linear ${
          ...
          <div className="tab-content">
            ...
            <div
              className={`tab-pane ${tab === 1 && "show active"} `}
