      ...
      <div className="sidebar-inner slimscroll">
        <div id="sidebar-menu" className="sidebar-menu">
          <ul className="no-underline">
            ...
            <li
              className={`${
                router.includes("/admin/dashboard/appointment") && "active"
              } `}
            >
              <Link
            ...
            <li
              className={`${
                router.includes("/admin/dashboard/doctors") && "active"
              } `}
            >
            ...
            <li
              className={`${
                router.includes("/admin/dashboard/patients") && "active"
              } `}
            >
            ...
            <li
              className={`${
                router.includes("/admin/dashboard/reviews") && "active"
              } `}
            >
